<template>
  <div>
    <div class="wrapper">
      <h1>Menu</h1>
      <a class="menu-btn" @click="toggleMenu()"></a>
      <section class="one" @click="goToPage(0)">
        <h1>Profile</h1>
      </section>
      <section class="two" @click="goToPage(1)">
        <h1>Friends</h1>
      </section>
      <section class="three" @click="goToPage(2)">
        <h1>Messages</h1>
      </section>
      <section class="four" @click="goToPage(3)">
        <h1>Settings</h1>
      </section>
    </div>
  </div>
